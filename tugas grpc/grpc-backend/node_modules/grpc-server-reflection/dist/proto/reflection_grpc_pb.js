...
var proto_reflection_pb = require('../proto/reflection_pb.js');

function serialize_grpc_reflection_v1alpha_ServerReflectionRequest(arg) {
  if (!(arg instanceof proto_reflection_pb.ServerReflectionRequest)) {
...
function deserialize_grpc_reflection_v1alpha_ServerReflectionRequest(buffer_arg) {
  return proto_reflection_pb.ServerReflectionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_grpc_reflection_v1alpha_ServerReflectionResponse(arg) {
  if (!(arg instanceof proto_reflection_pb.ServerReflectionResponse)) {
...
function deserialize_grpc_reflection_v1alpha_ServerReflectionResponse(buffer_arg) {
  return proto_reflection_pb.ServerReflectionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
serverReflectionInfo: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: proto_reflection_pb.ServerReflectionRequest,
    responseType: proto_reflection_pb.ServerReflectionResponse,
